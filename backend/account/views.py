...
from account.serializers.jwt import CustomTokenObtainPairSerializer
from account.serializers.user import CreateUserRegisterSerializer, UserActivationSerializer, \
...
from account.services.user_service import UserActivateService, UserPasswordResetService, \
